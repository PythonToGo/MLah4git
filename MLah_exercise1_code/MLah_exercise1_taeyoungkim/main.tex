...
\begin{figure}%
    \centering
    \subfloat{{\includegraphics[width=4cm]{A2/a2.image1.jpg} }}%
    \qquad
    \subfloat{{\includegraphics[width=4cm]{A2/a2.image2.jpg} }}%
...
\begin{figure}%[hbt!]
    \centering
    \subfloat{{\includegraphics[width=5cm]{A5/a5.falttopw.jpg} }}%
    \qquad
    \subfloat{{\includegraphics[width=5cm]{A5/a5.cpg.jpg} }}%
